...
\begin{figure*}[t]
\centerline{\includegraphics[width=0.7\linewidth]{../../../images/Anderson/Analise_Condicional/HR.png}}
\caption{Histograma e box-plot incondicional de HR.}
\label{fig:HR}
\end{figure*}

\begin{figure}[htbp]
\centerline{\includegraphics[width=1\linewidth]{../../../images/Anderson/Analise_Condicional/MEAN_RR.png}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{../../../images/Anderson/Scatter_Condicional/Scatter MEAN_RR x HR.png}
